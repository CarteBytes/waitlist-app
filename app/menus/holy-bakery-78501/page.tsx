...
import FooterLogoCTA from "@/app/playground/components/FooterLogoCTA";
import { isLight } from "@/app/playground/utils";
    ...
    if (section.type === "hero_image") {
      ...
      return (
        <div>
          ...
          <div className="flex flex-col gap-2 px-7 pb-8 pt-1">
